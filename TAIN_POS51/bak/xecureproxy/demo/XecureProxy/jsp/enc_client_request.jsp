...
<pre>
&lt;a href="enc_server_response.jsp" >&lt;/a>
</pre>
<a href="enc_server_response.jsp" >이동
</a><br><br>
...
<pre>
&lt;form action="enc_server_response.jsp?abc=def&amp;pop=hi" method="get" >
...
<pre>
&lt;form action="enc_server_response.jsp?abc=def&amp;pop=hi" method="post" >
<br>&lt;input type=text name="text_field1" >&lt;br>
<br>&lt;input type=text name="text_field2">&lt;br>
<br>&lt;input type=submit value="전송">
<br>&lt;/form>
...
<textarea name="text_field2" cols=90 rows=15>
</textarea><br>
<input type=submit value="전송">
</form>
<br>
