/*
 * Copyright (C) 1995-2007 OSS Nokalva, Inc.  All rights reserved.
 *
 * FILE: @(#)ossiaapi.h	16.5  07/03/27
*/
...
typedef enum ASN1Type { 
	...
	asn1ENUMERATED = 8,
	asn1EXTERNAL = 9,
	asn1GeneralString = 10,
	asn1GeneralizedTime = 11,
	asn1GraphicString = 12,
	asn1IA5String = 13,
	asn1INSTANCE_OF = 14,
	asn1INTEGER = 15,
	asn1NULL = 16,
	asn1NumericString = 17,
	asn1OBJECT_IDENTIFIER = 18,
	asn1OCTET_STRING = 19,
	asn1ObjectDescriptor = 20,
	asn1OpenType = 21,
	asn1PrintableString = 22,
	asn1REAL = 23,
	asn1SEQUENCE = 24,
	asn1SEQUENCE_OF = 25,
	asn1SET = 26,
	asn1SET_OF = 27,
	asn1TeletexString = 28,
	asn1UTCTime = 29,
	asn1UniversalString = 30,
	asn1VideotexString = 31,
	asn1VisibleString = 32,
	asn1UTF8String = 33,
	asn1RELATIVE_OID = 34,
	asn1CLASS = 35,
	asn1ArbitraryType = 36,
	asn1TIME = 37,
	asn1DATE = 38,
	asn1TIME_OF_DAY = 39,
	asn1DATE_TIME = 40,
